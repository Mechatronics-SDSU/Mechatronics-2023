...
#include "can_msg_interfaces/msg/detail/can_frame__rosidl_typesupport_fastrtps_c.h"
...
#include "can_msg_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _CanFrame__ros_msg_type = can_msg_interfaces__msg__CanFrame;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_can_msg_interfaces
size_t get_serialized_size_can_msg_interfaces__msg__CanFrame(
  const void * untyped_ros_message,
...
static uint32_t _CanFrame__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_can_msg_interfaces__msg__CanFrame(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_can_msg_interfaces
size_t max_serialized_size_can_msg_interfaces__msg__CanFrame(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_can_msg_interfaces__msg__CanFrame(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, can_msg_interfaces, msg, CanFrame)() {
