'''
    ...
    Subscribe to 'ahrs' topic to grab orientation info. This wil be in the form of an array:
        Element 0 - yaw
        Element 1 - pitch
        Element 2 - roll
'''
...
import sys
sys.path.append('/home/conner/ahrs_node/Mechatronics-2023/classes/ahrs_driver_lg')
sys.path.append('/home/mechatronics/test_ahrs/src')
...
class AHRS_Node(Node):
    ...
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(Position, 'ahrs', 10)           #transmits on 'ahrs' topic
    ...
    def timer_callback(self):
        ...
        if (yawFormatted != None and pitchFormatted != None and rollFormatted != None):
            msg = Position()
            msg.position = [yawFormatted, pitchFormatted, rollFormatted]
