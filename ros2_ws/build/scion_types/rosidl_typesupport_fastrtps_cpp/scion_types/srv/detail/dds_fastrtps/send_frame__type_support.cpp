...
#include "scion_types/srv/detail/send_frame__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const scion_types::srv::SendFrame_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scion_types::srv::SendFrame_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SendFrame_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const scion_types::srv::SendFrame_Request *>(
...
{
  return max_serialized_size_SendFrame_Request(full_bounded, 0);
}

static message_type_support_callbacks_t _SendFrame_Request__callbacks = {
  "scion_types::srv",
  "SendFrame_Request",
...
static rosidl_message_type_support_t _SendFrame_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SendFrame_Request__callbacks,
...
{
  return &scion_types::srv::typesupport_fastrtps_cpp::_SendFrame_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const scion_types::srv::SendFrame_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<scion_types::srv::SendFrame_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SendFrame_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const scion_types::srv::SendFrame_Response *>(
...
{
  return max_serialized_size_SendFrame_Response(full_bounded, 0);
}

static message_type_support_callbacks_t _SendFrame_Response__callbacks = {
  "scion_types::srv",
  "SendFrame_Response",
...
static rosidl_message_type_support_t _SendFrame_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SendFrame_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &scion_types::srv::typesupport_fastrtps_cpp::_SendFrame_Response__handle;
}
...
static service_type_support_callbacks_t _SendFrame__callbacks = {
  "scion_types::srv",
  "SendFrame",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scion_types, srv, SendFrame_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scion_types, srv, SendFrame_Response)(),
...
static rosidl_service_type_support_t _SendFrame__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SendFrame__callbacks,
...
{
  return &scion_types::srv::typesupport_fastrtps_cpp::_SendFrame__handle;
}
