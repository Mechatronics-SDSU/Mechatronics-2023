...
class Skeleton3D(metaclass=Metaclass_Skeleton3D):
    ...
    _fields_and_field_types = {
        'keypoints': 'zed_interfaces/Keypoint3D[34]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['zed_interfaces', 'msg'], 'Keypoint3D'), 34),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'keypoints' field must be a set or sequence with length 34 and each value of type 'Keypoint3D'"
