...
{
  const auto & member =
    *reinterpret_cast<const std::array<zed_interfaces::msg::Keypoint3D, 34> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<zed_interfaces::msg::Keypoint3D, 34> *>(untyped_member);
  return &member[index];
}
