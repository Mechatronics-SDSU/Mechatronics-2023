...
class ZedVision(Node):
    ...
    def __init__(self):
        ...
        # self.object.publisher_ = self.create_publisher(ZedObject, 'zed_object_data', 10)
        self.depth_publisher = self.create_publisher(Float32MultiArray, 'zed_image_data', 10)
    ...
    def timer_callback(self):
        ...
        msg.data = depth_map.get_data().flatten().tolist()
