...
static size_t _SetROI_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_zed_interfaces__srv__SetROI_Request(
    full_bounded, 0);
}
...
static size_t _SetROI_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_zed_interfaces__srv__SetROI_Response(
    full_bounded, 0);
}
