...
#include <stddef.h>
#include "can_msg_interfaces/msg/detail/can_frame__rosidl_typesupport_introspection_c.h"
#include "can_msg_interfaces/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  can_msg_interfaces__msg__CanFrame__init(message_memory);
}

void CanFrame__rosidl_typesupport_introspection_c__CanFrame_fini_function(void * message_memory)
{
  can_msg_interfaces__msg__CanFrame__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember CanFrame__rosidl_typesupport_introspection_c__CanFrame_message_member_array[2] = {
  {
    ...
    offsetof(can_msg_interfaces__msg__CanFrame, can_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(can_msg_interfaces__msg__CanFrame, can_data),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers CanFrame__rosidl_typesupport_introspection_c__CanFrame_message_members = {
  "can_msg_interfaces__msg",  // message namespace
  "CanFrame",  // message name
  2,  // number of fields
  sizeof(can_msg_interfaces__msg__CanFrame),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_can_msg_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, can_msg_interfaces, msg, CanFrame)() {
