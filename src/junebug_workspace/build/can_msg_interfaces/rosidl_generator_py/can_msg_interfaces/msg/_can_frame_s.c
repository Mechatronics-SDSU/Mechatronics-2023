...
bool can_msg_interfaces__msg__can_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("can_msg_interfaces.msg._can_frame.CanFrame", full_classname_dest, 42) == 0);
  }
  can_msg_interfaces__msg__CanFrame * ros_message = _ros_message;
  {  // can_id
...
PyObject * can_msg_interfaces__msg__can_frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("can_msg_interfaces.msg._can_frame");
