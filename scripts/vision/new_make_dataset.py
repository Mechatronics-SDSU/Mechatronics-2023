...
parser.add_argument('-f', help='Folder path to save images', required=True)
parser.add_argument('-d', help='Folder path to save images with date', required=True)
...
numbered_folder_path = args.f

if args.d is not None:
    date_folder_path = args.d
else:
    date_folder_path = args.f
