...
#include "scion_types/msg/detail/can_frame__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const scion_types::msg::CanFrame *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scion_types::msg::CanFrame *>(
    untyped_ros_message);
...
{
  return &scion_types::msg::typesupport_fastrtps_cpp::_CanFrame__handle;
}
