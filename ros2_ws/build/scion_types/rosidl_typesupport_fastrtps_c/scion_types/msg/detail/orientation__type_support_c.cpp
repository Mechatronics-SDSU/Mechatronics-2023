...
#include "rosidl_runtime_c/primitives_sequence.h"  // orientation
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // orientation
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: orientation
  {
    ...
    if (!rosidl_runtime_c__float__Sequence__init(&ros_message->orientation, size)) {
      return "failed to create array for field 'orientation'";
    }
    auto array_ptr = ros_message->orientation.data;
